...
use App\Http\Controllers\Api\V1\DressOccasionController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::get('/dress-occasions', [DressOccasionController::class, 'index']);
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::middleware('role:admin')->group(function (): void {
            ...
            Route::post('/dress-occasions', [DressOccasionController::class, 'store']);
            Route::patch('/dress-occasions/{dressOccasion}', [DressOccasionController::class, 'update']);
            Route::delete('/dress-occasions/{dressOccasion}', [DressOccasionController::class, 'destroy']);
